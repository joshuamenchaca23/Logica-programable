# DE10_Standard_Full_Assignments.tcl
# Dispositivo: Cyclone V SX SoC — 5CSXFC6D6F31C6
...
set_location_assignment PIN_AF23 -to HEX4[4]
set_location_assignment PIN_AF21 -to HEX4[5]
set_location_assignment PIN_Y21  -to HEX4[6]
# HEX5
set_location_assignment PIN_AF20 -to HEX5[0]
set_location_assignment PIN_AG20 -to HEX5[1]
set_location_assignment PIN_AE20 -to HEX5[2]
set_location_assignment PIN_AF19 -to HEX5[3]
set_location_assignment PIN_AH20 -to HEX5[4]
set_location_assignment PIN_AG21 -to HEX5[5]
set_location_assignment PIN_AH19 -to HEX5[6]
...
set_location_assignment PIN_AY10 -to GPIO[6]
set_location_assignment PIN_AK1  -to GPIO[7]
